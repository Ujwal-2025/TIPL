...
export default function HeroSection() {
    return (
        ...
        >
            ...
            {/* CTA Button */}
            <motion.button
                className="mt-10 px-8 py-4 rounded-full bg-gradient-to-r from-indigo-600 to-indigo-700 text-white font-semibold text-base relative group overflow-hidden border border-indigo-500/50 hover:border-indigo-400 transition-all"
